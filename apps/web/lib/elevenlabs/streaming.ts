...
import { pcm16LeBase64ToAudioBuffer } from "@/lib/audio/decode-pcm";
import type { VoiceMixer } from "@/lib/audio/voice-mixer";
      ...
      switch (frame.kind) {
        case "audio": {
          ...
          try {
            ...
            LogBus.warn("elevenlabs", "failed to decode audio frame", {
