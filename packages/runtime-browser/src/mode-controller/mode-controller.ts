...
import type { ClassifierResult } from "../sign-pipeline/classifier";
  ...
  return {
    ...
    ingest(result: ClassifierResult): void {
      ...
      if (
        ...
        log.debug("mode-controller", "auto-start", {
          label: top1.label,
          score: top1.score,
